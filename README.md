...
- Keep it short as possible, can a paragraph just be sentence? Do you need long sentences when a shorter simple one will do? Keep it simple, don’t use 'sesquicentennial' when you can just say 'hard'.
